...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function bindEvent(el, result, data, createFunc) {
			var fileUrl = K.formatUrl(result.current_url + (data.filePath == null ? data.filename:data.filePath) , 'absolute'),
		...
		function createView(result) {
			...
			for (var i = 0, len = fileList.length; i < len; i++) {
				...
				div.append(photoDiv);
				var fileUrl = result.current_url + (data.filePath == null ? data.filename:data.filePath),
...
KindEditor.plugin('multiimage', function(K) {
	var src_type_h = $("#img_src_type").val();
	
	var self = this, name = 'multiimage',
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
		uploadJson = K.undef(self.uploadJson+"?src_type_h="+src_type_h, self.basePath + 'php/upload_json.php'),
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var beforeRemove = options.beforeRemove;
		var dialog = self.createDialog({
			name : name,
			width : 650,
			height : 510,
