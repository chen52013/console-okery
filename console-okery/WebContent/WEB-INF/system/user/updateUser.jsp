		...
		<form id="updateUserForm" name="updateUserForm" action="" method="post">
			...
			<table id="updateUserFormTable" class="table table-bordered table-hover">
				...
				<tr>
					...
					<td width="10%" class="tableleft" ><label class="control-label">是否授权</label></td>
					<td>
						<select id="is_auth" name="is_auth">
		          			<option value="1" ${userBean.is_auth eq "1" ? "selected":""}>是</option>
		          			<option value="0" ${userBean.is_auth eq "0" ? "selected":""}>否</option>
		     			</select>
					</td>
				</tr>
				<tr>
