 ...
 * File Name:CustomConcurrentSessionFilter.java
...
/**
 * ClassName:CustomConcurrentSessionFilter <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:   TODO ADD REASON. <br/>
 * Date:     2016�?�?�?上午9:47:28 <br/>
 * @author  雷湘�?
 * @version
 * @since    JDK 1.7
 * @see
...
public class CustomConcurrentSessionFilter extends GenericFilterBean {
    ...
    public void afterPropertiesSet() {
        ...
        Assert.isTrue((expiredUrl == null) ||
            UrlUtils.isValidRedirectUrl(expiredUrl),
            ...
            if (info != null) {
                if (info.isExpired()) {
                    ...
                    if (targetUrl != null) {
                        ...
                        out.write("你被另一个相同用户踢出！".getBytes("UTF-8"));
